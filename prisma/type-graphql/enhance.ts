...
const relationResolversInfo = {
  ...
  CategoriesOnPosts: ['post', 'category', 'createdBy'],
  TagsOnPosts: ['post', 'tag', 'createdBy'],
  User: ['posts', 'CategoriesOnPosts', 'TagsOnPosts'],
}
...
const modelsInfo = {
  ...
  CategoriesOnPosts: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPosts: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
...
const outputsInfo = {
  ...
  CategoriesOnPostsGroupBy: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt', '_count', '_avg', '_sum', '_min', '_max'],
  AggregateTagsOnPosts: ['_count', '_avg', '_sum', '_min', '_max'],
  TagsOnPostsGroupBy: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', '_count', '_avg', '_sum', '_min', '_max'],
  ...
  CategoriesOnPostsCountAggregate: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt', '_all'],
  CategoriesOnPostsAvgAggregate: ['postId', 'categoryId', 'createdById'],
  CategoriesOnPostsSumAggregate: ['postId', 'categoryId', 'createdById'],
  CategoriesOnPostsMinAggregate: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsMaxAggregate: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsCountAggregate: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', '_all'],
  TagsOnPostsAvgAggregate: ['postId', 'tagId', 'createdById'],
  TagsOnPostsSumAggregate: ['postId', 'tagId', 'createdById'],
  TagsOnPostsMinAggregate: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsMaxAggregate: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  UserCount: ['posts', 'CategoriesOnPosts', 'TagsOnPosts'],
...
const inputsInfo = {
  ...
  CategoriesOnPostsWhereInput: ['AND', 'OR', 'NOT', 'postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt', 'post', 'category', 'createdBy'],
  CategoriesOnPostsOrderByWithRelationInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt', 'post', 'category', 'createdBy'],
  ...
  CategoriesOnPostsOrderByWithAggregationInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt', '_count', '_avg', '_max', '_min', '_sum'],
  CategoriesOnPostsScalarWhereWithAggregatesInput: ['AND', 'OR', 'NOT', 'postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsWhereInput: ['AND', 'OR', 'NOT', 'postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', 'post', 'tag', 'createdBy'],
  TagsOnPostsOrderByWithRelationInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', 'post', 'tag', 'createdBy'],
  TagsOnPostsWhereUniqueInput: ['postId_tagId', 'AND', 'OR', 'NOT', 'postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', 'post', 'tag', 'createdBy'],
  TagsOnPostsOrderByWithAggregationInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt', '_count', '_avg', '_max', '_min', '_sum'],
  TagsOnPostsScalarWhereWithAggregatesInput: ['AND', 'OR', 'NOT', 'postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  UserWhereInput: [
    'AND',
    'OR',
    'NOT',
  ...
  CategoriesOnPostsCreateInput: ['createdAt', 'updatedAt', 'post', 'category', 'createdBy'],
  CategoriesOnPostsUpdateInput: ['createdAt', 'updatedAt', 'post', 'category', 'createdBy'],
  CategoriesOnPostsCreateManyInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsUpdateManyMutationInput: ['createdAt', 'updatedAt'],
  TagsOnPostsCreateInput: ['createdAt', 'updatedAt', 'post', 'tag', 'createdBy'],
  TagsOnPostsUpdateInput: ['createdAt', 'updatedAt', 'post', 'tag', 'createdBy'],
  TagsOnPostsCreateManyInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsUpdateManyMutationInput: ['createdAt', 'updatedAt'],
  UserCreateInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'CategoriesOnPosts', 'TagsOnPosts'],
  UserUpdateInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'CategoriesOnPosts', 'TagsOnPosts'],
  ...
  CategoriesOnPostsCountOrderByAggregateInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsAvgOrderByAggregateInput: ['postId', 'categoryId', 'createdById'],
  CategoriesOnPostsMaxOrderByAggregateInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsMinOrderByAggregateInput: ['postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsSumOrderByAggregateInput: ['postId', 'categoryId', 'createdById'],
  TagRelationFilter: ['is', 'isNot'],
  TagsOnPostsPostIdTagIdCompoundUniqueInput: ['postId', 'tagId'],
  TagsOnPostsCountOrderByAggregateInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsAvgOrderByAggregateInput: ['postId', 'tagId', 'createdById'],
  TagsOnPostsMaxOrderByAggregateInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsMinOrderByAggregateInput: ['postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsSumOrderByAggregateInput: ['postId', 'tagId', 'createdById'],
  ...
  UserCreateNestedOneWithoutCategoriesOnPostsInput: ['create', 'connectOrCreate', 'connect'],
  ...
  UserUpdateOneRequiredWithoutCategoriesOnPostsNestedInput: ['create', 'connectOrCreate', 'upsert', 'connect', 'update'],
  ...
  UserCreateNestedOneWithoutTagsOnPostsInput: ['create', 'connectOrCreate', 'connect'],
  ...
  UserUpdateOneRequiredWithoutTagsOnPostsNestedInput: ['create', 'connectOrCreate', 'upsert', 'connect', 'update'],
  PostCreateNestedManyWithoutAuthorInput: ['create', 'connectOrCreate', 'createMany', 'connect'],
  CategoriesOnPostsCreateNestedManyWithoutCreatedByInput: ['create', 'connectOrCreate', 'createMany', 'connect'],
  TagsOnPostsCreateNestedManyWithoutCreatedByInput: ['create', 'connectOrCreate', 'createMany', 'connect'],
  ...
  CategoriesOnPostsUpdateManyWithoutCreatedByNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'createMany',
  ...
  TagsOnPostsUpdateManyWithoutCreatedByNestedInput: [
    'create',
    'connectOrCreate',
    'upsert',
    'createMany',
  ...
  UserCreateWithoutPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'CategoriesOnPosts', 'TagsOnPosts'],
  UserCreateOrConnectWithoutPostsInput: ['where', 'create'],
  CategoriesOnPostsCreateWithoutPostInput: ['createdAt', 'updatedAt', 'category', 'createdBy'],
  ...
  TagsOnPostsCreateWithoutPostInput: ['createdAt', 'updatedAt', 'tag', 'createdBy'],
  ...
  UserUpdateWithoutPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'CategoriesOnPosts', 'TagsOnPosts'],
  ...
  CategoriesOnPostsScalarWhereInput: ['AND', 'OR', 'NOT', 'postId', 'categoryId', 'createdById', 'createdAt', 'updatedAt'],
  ...
  TagsOnPostsScalarWhereInput: ['AND', 'OR', 'NOT', 'postId', 'tagId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsCreateWithoutTagInput: ['createdAt', 'updatedAt', 'post', 'createdBy'],
  ...
  CategoriesOnPostsCreateWithoutCategoryInput: ['createdAt', 'updatedAt', 'post', 'createdBy'],
  ...
  UserCreateWithoutCategoriesOnPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'TagsOnPosts'],
  UserCreateOrConnectWithoutCategoriesOnPostsInput: ['where', 'create'],
  ...
  UserUpsertWithoutCategoriesOnPostsInput: ['update', 'create', 'where'],
  UserUpdateToOneWithWhereWithoutCategoriesOnPostsInput: ['where', 'data'],
  UserUpdateWithoutCategoriesOnPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'TagsOnPosts'],
  ...
  UserCreateWithoutTagsOnPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'CategoriesOnPosts'],
  UserCreateOrConnectWithoutTagsOnPostsInput: ['where', 'create'],
  ...
  UserUpsertWithoutTagsOnPostsInput: ['update', 'create', 'where'],
  UserUpdateToOneWithWhereWithoutTagsOnPostsInput: ['where', 'data'],
  UserUpdateWithoutTagsOnPostsInput: ['createdAt', 'updatedAt', 'nickName', 'email', 'password', 'avatar', 'role', 'posts', 'CategoriesOnPosts'],
  ...
  CategoriesOnPostsCreateWithoutCreatedByInput: ['createdAt', 'updatedAt', 'post', 'category'],
  CategoriesOnPostsCreateOrConnectWithoutCreatedByInput: ['where', 'create'],
  CategoriesOnPostsCreateManyCreatedByInputEnvelope: ['data', 'skipDuplicates'],
  TagsOnPostsCreateWithoutCreatedByInput: ['createdAt', 'updatedAt', 'post', 'tag'],
  TagsOnPostsCreateOrConnectWithoutCreatedByInput: ['where', 'create'],
  TagsOnPostsCreateManyCreatedByInputEnvelope: ['data', 'skipDuplicates'],
  ...
  CategoriesOnPostsUpsertWithWhereUniqueWithoutCreatedByInput: ['where', 'update', 'create'],
  CategoriesOnPostsUpdateWithWhereUniqueWithoutCreatedByInput: ['where', 'data'],
  CategoriesOnPostsUpdateManyWithWhereWithoutCreatedByInput: ['where', 'data'],
  TagsOnPostsUpsertWithWhereUniqueWithoutCreatedByInput: ['where', 'update', 'create'],
  TagsOnPostsUpdateWithWhereUniqueWithoutCreatedByInput: ['where', 'data'],
  TagsOnPostsUpdateManyWithWhereWithoutCreatedByInput: ['where', 'data'],
  CategoriesOnPostsCreateManyPostInput: ['categoryId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsCreateManyPostInput: ['tagId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsUpdateWithoutPostInput: ['createdAt', 'updatedAt', 'category', 'createdBy'],
  TagsOnPostsUpdateWithoutPostInput: ['createdAt', 'updatedAt', 'tag', 'createdBy'],
  TagsOnPostsCreateManyTagInput: ['postId', 'createdById', 'createdAt', 'updatedAt'],
  TagsOnPostsUpdateWithoutTagInput: ['createdAt', 'updatedAt', 'post', 'createdBy'],
  CategoriesOnPostsCreateManyCategoryInput: ['postId', 'createdById', 'createdAt', 'updatedAt'],
  CategoriesOnPostsUpdateWithoutCategoryInput: ['createdAt', 'updatedAt', 'post', 'createdBy'],
  PostCreateManyAuthorInput: ['id', 'createdAt', 'updatedAt', 'title', 'description', 'content', 'published', 'favoNum', 'browNum'],
  CategoriesOnPostsCreateManyCreatedByInput: ['postId', 'categoryId', 'createdAt', 'updatedAt'],
  TagsOnPostsCreateManyCreatedByInput: ['postId', 'tagId', 'createdAt', 'updatedAt'],
  ...
  CategoriesOnPostsUpdateWithoutCreatedByInput: ['createdAt', 'updatedAt', 'post', 'category'],
  TagsOnPostsUpdateWithoutCreatedByInput: ['createdAt', 'updatedAt', 'post', 'tag'],
}
