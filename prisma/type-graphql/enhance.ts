...
const outputsInfo = {
  ...
  UserGroupBy: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password', '_count', '_avg', '_sum', '_min', '_max'],
  ...
  UserCountAggregate: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password', '_all'],
  UserAvgAggregate: ['id'],
  UserSumAggregate: ['id'],
...
const inputsInfo = {
  ...
  UserWhereInput: ['AND', 'OR', 'NOT', 'id', 'createdAt', 'updatedAt', 'name', 'email', 'password', 'posts', 'profile'],
  UserOrderByWithRelationInput: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password', 'posts', 'profile'],
  UserWhereUniqueInput: ['id', 'email', 'AND', 'OR', 'NOT', 'createdAt', 'updatedAt', 'name', 'password', 'posts', 'profile'],
  UserOrderByWithAggregationInput: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password', '_count', '_avg', '_max', '_min', '_sum'],
  UserScalarWhereWithAggregatesInput: ['AND', 'OR', 'NOT', 'id', 'createdAt', 'updatedAt', 'name', 'email', 'password'],
  ...
  UserCreateInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'posts', 'profile'],
  UserUpdateInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'posts', 'profile'],
  UserCreateManyInput: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password'],
  UserUpdateManyMutationInput: ['createdAt', 'updatedAt', 'name', 'email', 'password'],
  ...
  UserCountOrderByAggregateInput: ['id', 'createdAt', 'updatedAt', 'name', 'email', 'password'],
  ...
  UserCreateWithoutPostsInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'profile'],
  UserCreateOrConnectWithoutPostsInput: ['where', 'create'],
  UserUpsertWithoutPostsInput: ['update', 'create', 'where'],
  UserUpdateToOneWithWhereWithoutPostsInput: ['where', 'data'],
  UserUpdateWithoutPostsInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'profile'],
  UserCreateWithoutProfileInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'posts'],
  ...
  UserUpdateWithoutProfileInput: ['createdAt', 'updatedAt', 'name', 'email', 'password', 'posts'],
